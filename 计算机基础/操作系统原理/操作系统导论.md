...
实现起来相当困难，对于一个新进入的工作很难遇到其完成工作的所需时间
...
<center>
<img src="https://picture-in-md.oss-cn-guangzhou.aliyuncs.com/2023-03-23_141552.png" width="700" />
</center>

- pthread_cond_wait 调用使线程进入休眠状态，直到其他线程发出条件信号；等待调用除了使得线程睡眠还让线程睡眠时释放锁，在被唤醒之后又会重新获得锁
- signal 调用用于发信号，唤醒线程
