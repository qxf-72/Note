<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/jpeg/29674612/1681453922194-19305b65-59a1-4afb-af3f-84f33c9b416f.jpeg" width="500" /> </div>
...
- 统一编址：将IO地址看成存储器地址一部分，分出部分存储器地址给IO编号。
...
此时进行加法不必判断大小，进行减法时，即加上减数的补码，补码和原码的快速转换——原码取反加一
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680003001555-1a35f9eb-076a-4cd1-9d15-96666a76d27c.png#averageHue=%23fefdf9&from=url&height=282&id=vmVgs&originHeight=874&originWidth=620&originalType=binary&ratio=1&rotation=0&showTitle=false&size=43825&status=done&style=none&title=&width=200" width="200" /> </div>
...
\end{array} \right.$
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680003186147-26d4b56c-677f-48fa-b579-f996dbc993a4.png#averageHue=%23fefdf9&from=url&height=271&id=jcfQu&originHeight=1111&originWidth=819&originalType=binary&ratio=1&rotation=0&showTitle=false&size=57499&status=done&style=none&title=&width=200" width="200" /> </div>
...
**移码表示法**
由于补码表示很难直接判断真值的大小，所以引入了移码，移码的本质就是 补码+$2^n$，移码和补码的符号为相反，数字位相同
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1679972690573-500f0b65-459f-453b-b316-d11044874fb5.png#averageHue=%23f9f9f8&clientId=ua031862e-d260-4&from=ui&height=134&id=u9d8e0799&originHeight=305&originWidth=913&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=11734&status=done&style=none&taskId=u1c0c1228-df30-42ff-99a1-3c06a66ed58&title=&width=400" width="400" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680007216234-291a5dbe-abbf-417f-b0e6-e13e347f2f90.png#averageHue=%23eeeeee&clientId=u45d1c768-a2ac-4&from=ui&height=118&id=ue0837390&originHeight=204&originWidth=868&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=42257&status=done&style=none&taskId=u3d253f80-3e4d-4633-8dec-a12b3f15bdf&title=&width=500" width="500" /> </div>


### 浮点表示
通常浮点数被表示成$N=S\times r^j$
其中为$S$尾数（可正可负），为$j$阶数（可正可负），$r$为基数，在计算机中基数可去2,4,8或16

**浮点数的表现形式**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680007427416-26e7f445-9a33-49e7-adab-e03a640fb2ca.png#averageHue=%23f2f2f1&clientId=u45d1c768-a2ac-4&from=ui&height=149&id=u3ecbb134&originHeight=431&originWidth=1444&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=49533&status=done&style=none&taskId=u6b475b26-2b0e-40bd-9f84-7bc1315bfe3&title=&width=500" width="500" /> </div>


阶符和阶码的位数m反映浮点数的表示范围以及小数点的实际位置，尾数的位数n表示浮点数的精度

**浮点数的表示范围**
以非格式化数为例，当阶数的数值为取m位，尾数的数值位取n位，其表示范围如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680007725906-54b8cf0a-314e-4dda-bd70-874b2776349b.png#averageHue=%23f6f6f2&clientId=u45d1c768-a2ac-4&from=ui&height=184&id=uac06a15b&originHeight=609&originWidth=1655&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=41336&status=done&style=none&taskId=u413649df-9b92-4752-a059-1c3fb4b5b14&title=&width=500" width="500" /> </div>


当浮点数阶码大于最大阶码时上溢，机器停止运算，进行中断溢出处理，当阶码小于最小阶码时下溢，通常将尾数各位置零，按机器零处理，不会停止运行

**浮点数格式化**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680007940200-83aa6fad-5c1e-4b6e-adf4-f7e13bde3e63.png#averageHue=%23efefee&clientId=u45d1c768-a2ac-4&from=ui&height=84&id=u81b4a16e&originHeight=263&originWidth=1570&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=52485&status=done&style=none&taskId=u29891b77-e960-4062-875d-b49f358c7c6&title=&width=500" width="500" /> </div>


$r$越大，浮点数可表示的范围越大，能表示的数的个数越多；但是浮点数的精度越低

**机器零**
当尾数为0时，不论阶数为何值，通通按照机器零处理；当阶码小于或等于所能表示的最小数时，不论尾数为何值，也按照机器零处理

### IEEE 754标准
现代计算机中，浮点数一般采用IEEE指定的国际标准，格式如下
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680008497495-7bd4783f-264e-4674-b6c6-467de0dfd4ac.png#averageHue=%23dededd&clientId=u45d1c768-a2ac-4&from=ui&height=90&id=ud5683d70&originHeight=255&originWidth=1415&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=24634&status=done&style=none&taskId=uf9b286f1-99b5-4582-b5c3-0496f83fd47&title=&width=500" width="500" /> </div>


32位浮点数和64位浮点数
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/jpeg/29674612/1688195498880-9fbec4e3-bc8a-4086-a747-29217f69cc6c.jpeg#averageHue=%23f6f2e6&clientId=u8baff925-f2e3-4&from=ui&height=259&id=u74a5692f&originHeight=717&originWidth=1384&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=192156&status=done&style=none&taskId=u164c6410-bb48-46a1-b24d-78cabf4c0db&title=&width=500" width="500" /> </div>


<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/jpeg/29674612/1688195518586-8bb34dcc-8b82-4a0d-83fc-0e9073a27b65.jpeg#averageHue=%23f7f6d7&clientId=u8baff925-f2e3-4&from=ui&height=113&id=u675cc292&originHeight=175&originWidth=1082&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=41679&status=done&style=none&taskId=u1a1edc84-d611-4aff-832e-a0e07f514ee&title=&width=700" width="700" /> </div>
...
算术移位规则
对于算术移位，符号位不参与移位，且是正数是原码、反码、补码数值位与真值相同，左右移动都填“0”；对于负数补码，由于补码转原码“取反加一”的性质，左移添“0”，右移添“1”。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680011274488-65e10834-159c-4c39-9f7a-842348bdfb40.png#averageHue=%23eeeeee&clientId=u45d1c768-a2ac-4&from=ui&height=187&id=ua6ab3300&originHeight=395&originWidth=1481&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=165933&status=done&style=none&taskId=u80fcaa99-fa02-463d-a0a4-df03fe90ff2&title=&width=700" width="700" /> </div>


当有有效数字丢失时

- 对于正数：高位丢1，出错，低位丢1，影响精度
- 对于负数：补码需要特别注意，高位丢0出错，低位丢1，影响精度

**实现算术移位的硬件**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680011514832-9f31a95f-3472-4ee0-aa14-272293beb79d.png#averageHue=%23e9e9e9&clientId=u45d1c768-a2ac-4&from=ui&height=155&id=u7430c0f8&originHeight=262&originWidth=1014&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=66523&status=done&style=none&taskId=ue24d7a3a-7b3e-42ed-a340-3b93777f3da&title=&width=600" width="600" /> </div>


负数且进行右移时，可以利用符号为进行添1操作

**算术移位与逻辑移位**
算术移位是有符号数的移位， 逻辑移位是无符号数的移位；两者移位的规则是不一样的，对于逻辑移位，左右移位都是补0，而对于算术移位，补0还是补1，取决于操作数的类型（是原码还是补码），以及是左移还是右移
为了避免算术左移是高位数丢失，可以使用带进位的移位，将最高位数字移动到进位中
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680157318390-7ed93229-87ed-4dbf-94d7-c3898d728bb9.png#averageHue=%23e6e6e6&clientId=ue90042cd-81d1-4&from=ui&height=101&id=u16d1d5b5&originHeight=133&originWidth=525&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=4767&status=done&style=none&taskId=u809af72f-1291-4a13-bd84-f9b215e1a62&title=&width=400" width="400" /> </div>


### 加法运算
由于减法运算可以看作是一个被减数加上减数的负值，现代计算机都采用补码加法作减法运算
**补码加法基本公式**
整数：$\left[ A+B \right] _补\left( mod\ 2^{n+1} \right) =\left[ A \right] _补+\left[ B \right] _补$
...
**溢出的判断**
只用一位符号位判断——如果两个操作数符号不同，则必然不会溢出，如果符号位相同，结果的符号为和操作数符号位不同的话，就必然溢出；因此通常采用符号位产生的进位和最高有效位产生的进位进行异或运算，结果为1则溢出 ^f9233d

用两个符号为进行判断——适用于符号位有两位的变形补码，其定义如下：
$\left[ X \right] _补=\left\{ \begin{array}{l}
	x\,\,\,\,\,\,,1>x\ge 0\\
	4+x\,\,\,\,,0>x\ge -1\\
\end{array} \right.$
变形补码溢出判断原则是——2个符号位不同时就溢出；无论是否溢出，最高移位符号为才是代表真正符号位
当采用双符号位方案时，由于一个正确的数，其两个符号位总是相同的，所以寄存器和主存中的操作数只需保存移位符号数即可，在相加时，将保存的一位符号位同时送到加法器的两位符号位输入端

**补码加减法硬件配置**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680162369448-9211c7b7-e1fe-4d0e-98fb-27fbee4e9acc.png#averageHue=%23efefef&clientId=ue90042cd-81d1-4&from=ui&height=233&id=u392b6519&originHeight=798&originWidth=2053&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=164400&status=done&style=none&taskId=u418f4e24-302e-440b-a92f-065407e4234&title=&width=600" width="600" /> </div>
...
**笔算乘法**
以下是笔算乘法的一个例子
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680225993238-bb97d2c0-ca93-457e-a243-4b41f0d2f690.png#averageHue=%23f3f3f3&clientId=ufac93902-984f-4&from=ui&height=165&id=u339989de&originHeight=226&originWidth=549&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=34454&status=done&style=none&taskId=u7c4581b8-8956-497a-8255-eab38095eb9&title=&width=400" width="400" /> </div>
...
**原码一位乘法**
原码和真值很相近，乘积的符号可以通过符号位异或运算获得，数值位进行相乘的过程和改进后的笔算乘法过程一样，故原码一位乘法规则如下：

- 乘积符号位由两数的符号位异或运算结果决定
- 乘积数值部分有两数绝对值部分（即不要符号位）相乘得到，通式如下：

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680226285453-6dcd7c8b-47e2-4727-af7f-1f7ae7faee54.png#averageHue=%23f8f8f8&clientId=ufac93902-984f-4&from=ui&height=190&id=u2761aee2&originHeight=252&originWidth=795&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=true&size=32084&status=done&style=none&taskId=u6bf625f1-29ba-4619-9b2b-b83210c7dce&title=%E5%AE%9A%E7%82%B9%E5%B0%8F%E6%95%B0%E5%8E%9F%E7%A0%81%E4%B8%80%E4%BD%8D%E4%B9%98%E6%B3%95&width=600 "定点小数原码一位乘法"" width="600" /> </div>



- 对于整数原码乘法，对于部分积还要左移$n$位得到正确结果

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/jpeg/29674612/1680245813194-57d7b310-c062-4ebf-b843-75a7bf69bf08.jpeg#averageHue=%23f8f8f8&from=url&height=161&id=jxrRF&originHeight=340&originWidth=1270&originalType=binary&ratio=1&rotation=0&showTitle=false&size=61291&status=done&style=none&title=&width=600" width="600" /> </div>



原码一位乘法需要注意：

- 部分积取$n+1$位，存放乘法过程中绝对值超过$n$位的值
- 乘积的数值部分是两数绝对值相乘的结果，故移位运算为逻辑右移

原码一位乘法硬件配置：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680226617686-2db0d5c7-c3cf-4b29-a2c3-f1bd92c9166c.png#averageHue=%23f1f1f1&clientId=ufac93902-984f-4&from=ui&height=316&id=u6e411cbf&originHeight=416&originWidth=791&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=65359&status=done&style=none&taskId=u714faa4a-5cec-4a67-99cc-f5a8635b89a&title=&width=600" width="600" /> </div>



- A、X、Q均为n+1位的寄存器，X存放被乘数原码，Q存放乘数原码，A存放部分积
- S存放乘积符号，Gm为乘法标记
- 计数器C存放乘数位数（如果乘数原码除了符号位之外有$n$位，就设为$n$）

控制流程如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680226913647-767ac212-2c12-49bc-b92d-8cb97312cbea.png#averageHue=%23f6f6f6&clientId=ufac93902-984f-4&from=ui&height=498&id=uabb12f2d&originHeight=817&originWidth=821&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=108303&status=done&style=none&taskId=u232261df-ce54-48d9-b15c-c26f55ee98a&title=&width=500" width="500" /> </div>



**原码两位乘法**
为了提高运算速度，采用原码两位乘法，原码两位乘法用两位乘数位来决定新的部分积，如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680227067712-61050576-f063-41a4-8840-23c1815fdeb1.png#averageHue=%23eaeaea&clientId=ufac93902-984f-4&from=ui&height=170&id=u04b5e520&originHeight=309&originWidth=1273&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=153321&status=done&style=none&taskId=ub3c2c30a-a09a-4a83-918d-48bba6b7efd&title=&width=700" width="700" /> </div>


2倍的被乘数，相当于被乘数左移1位，3倍被乘数相当于4倍被乘数（左移两位）减去一个被乘数；可以将被乘数左移两位的操作较为下一个乘数的两位去完成，当前只需要进去一个被乘数即可，此时需要一个存储器$C_j$进行标记
由于需要进行$-x^*$的操作，一般用$+[x^*]_{补}$完成，所以两个操作数是绝对值的补码，移位运算是算术移位
在乘法过程中，需要2倍的被乘数，为了避免高位丢失，部分积需要3个符号位（也就是需要额外2位放置溢出），其中最高位才是真正的符号位
为了统一操作，需要在乘数高位增添“0”，乘数位数为奇数时增添一个0，为偶数时增添两个0

- 乘数数位$n$为偶数时，需要做$n/2$次移位，$n/2+1$次加法（将C设置为$n/2$，当C为0时只做加法不移位）
- 乘数数位$n$为奇数时，需要做$n/2+1$次移位，$n/2+1$次加法（将C设置为$n/2$，每一步都要加法和移位）
...
可以看出，可以乘数为负数的乘法看成是乘数为正数（乘数去掉符号位）的乘法，同时最后得到的结果加上$[-x]_补$进行校正，故称为校正法。

3）**Booth算法**
该算法由校正法得出，也称为比较法，可以用一个统一的公式表示
$\left[ x*y \right] _补=\left[ x \right] _补\left( 0\ y_1\ y_2\ ...\ y_n \right) -\left[ x \right] _补*y_0$

可将以上算式改写
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680231810998-b69bc35d-bea2-42b0-b7ae-50afe16caf5d.png#averageHue=%23f5f5f5&clientId=ufac93902-984f-4&from=ui&height=142&id=ua988d29a&originHeight=238&originWidth=1003&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=48778&status=done&style=none&taskId=u2c5469e2-1e55-4166-8b2c-2039efe24bf&title=&width=600" width="600" /> </div>


其中$y_{n+1}=0$
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680231878223-86f6f096-cc68-4d7a-bb86-05d24e5541f7.png#averageHue=%23eeeeee&clientId=ufac93902-984f-4&from=ui&height=190&id=u4d631cb3&originHeight=333&originWidth=1225&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=126338&status=done&style=none&taskId=u5ad8f126-baa0-4e0d-bd01-c319e30f814&title=&width=700" width="700" /> </div>


补码比较法的硬件配置：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680232065706-aba12e4c-a541-48b6-869d-12eb27a91b48.png#averageHue=%23ededed&clientId=ufac93902-984f-4&from=ui&height=274&id=udbc890d8&originHeight=429&originWidth=626&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=62146&status=done&style=none&taskId=u06433264-a527-421e-b51b-42d4d64ca07&title=&width=400" width="400" /> </div>


补码比较法的控制流程：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680232189017-42f9fb9c-678e-4b82-9d06-6ad8f41cdf25.png#averageHue=%23f5f5f5&clientId=ufac93902-984f-4&from=ui&height=448&id=u890af09a&originHeight=861&originWidth=960&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=117140&status=done&style=none&taskId=ua12eba77-5dac-453a-8304-8cd1f1af933&title=&width=500" width="500" /> </div>



**补码两位乘法**
补码两位乘法是将判断$y_{n-1}y_n$和$y_ny_{n-1}$，也就是将下次和本次的部分积加减情况合并，需要注意的是下一个的加减情况要乘以2
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680232613651-37d72b77-ef89-4b72-ba76-a7bd292b03cf.png#averageHue=%23ececec&clientId=ufac93902-984f-4&from=ui&height=291&id=uc86a09a2&originHeight=509&originWidth=1226&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=53956&status=done&style=none&taskId=u9199eef3-3759-4ad6-ada5-679cfd5f056&title=&width=700" width="700" /> </div>
...
- 机器不能直接判断上商0还是1，需要通过余数减去除数数的大小是正是负来判断
- 笔算除法每次总是余数不同低位补0，除数右移一位，这种方式需要，两倍除数字长的加法器，可以用左移余数的方法来代替
- 机器难以将每位商直接写到寄存器的某个位置，可将商先写入寄存器低位，然后左移一位

**原码除法**
符号位单独处理，商符号由两个操作数符号异或得出，商值由两操作数绝对值相除得到
对于定点除法，必须满足$0<|被除数|<=|除数|$，实际计算中当被除数为0，结果直接返回0，当除数为0，中断计算并报错

1. **恢复余数法**

先用余数减去除数得到新的余数，根据结果为正还是为负进行处理

- 余数为负时：上商0，并将余数加上除数恢复，然后余数左移
- 余数为正时：上商1，然后余数左移

$n$为数位的原码进行除法时，进行$n+1$次上商，$n$次移位（用计数器$C=n$判断运算是否结束，$C=0$时还要进行最后一次上商）
第一次上商的结果在符号位上面（最后会被覆盖），可以根据第一次上商结果判断是否溢出
...
- $R_i>0$，上商1，做$2R_i-y^*$运算
- $R_i<0$，上商0，做$2R_i+y^*$运算

运算流程如下
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680573855373-79dd5531-5599-485b-90c1-e5d1c7bb6a1a.png#averageHue=%23f8f8f8&clientId=ufba046c1-b6a5-4&from=ui&height=786&id=ufe3d21af&originHeight=1113&originWidth=991&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=184596&status=done&style=none&taskId=ub8094c96-6c83-4bb3-b382-14e41ffa862&title=&width=700" width="700" /> </div>



**补码除法**
一般采用加减交替法，在此只讨论这种方法
由于补码除法是符号位和数值位一起参与运算的，所以相较于原码除法需要额外解决几个问题：（1）如何确定商值（2）如何形成商符（3）如何获得新的余数
...
可以根据以上两种结论总结得到以下结果：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680574775828-0b047c01-eb75-4fc6-9f3e-e4566ff5a52e.png#averageHue=%23eeeeee&clientId=ufba046c1-b6a5-4&from=ui&height=123&id=u8afa01a9&originHeight=169&originWidth=962&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=70355&status=done&style=none&taskId=u278fadbe-2bbc-40e2-993c-7e1f7678cf6&title=&width=700" width="700" /> </div>
...
和原码加减交替法类似
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680574909436-153afc1c-b915-43e8-92f0-6bff933316bc.png#averageHue=%23ebebeb&clientId=ufba046c1-b6a5-4&from=ui&height=102&id=u3fec12e2&originHeight=144&originWidth=987&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=71387&status=done&style=none&taskId=ucd062cce-bb59-401b-90cd-2652585d0ad&title=&width=700" width="700" /> </div>
...
补码除法控制流程如下
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680575166112-7f0d4c3c-2643-44c9-93d9-72ba41e3ffdb.png#averageHue=%23f6f6f6&clientId=ufba046c1-b6a5-4&from=ui&height=697&id=ua85d6ef0&originHeight=819&originWidth=823&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=129387&status=done&style=none&taskId=u3c139e11-6a5e-4019-b28d-8829d8d58ac&title=&width=700" width="700" /> </div>
...
### 浮点加减法
**对阶**
使得两操作数的小数点对齐，遵循的原则是——小阶向大阶对其，即阶小的数尾数右移，阶数增加
...
可以看出，当完成规格化时，数值最高位和符号位相反，可以用异或运算判断，有以下例外情况：

- $S=-1/2$，$[S]_补$=11 .100...0，为了便于硬件判断，规定$-1/2$不是规格化的数

规格化可以分为左规和右规，以下两种移位运算都是算术移位：

- 左规：当尾数不满足规划化形式时，进行左规运算——数值位左移，阶数减一，直到符号位和数值最高位符号不同
- 右规：当两个符号位符号不同时，此时表示尾数溢出，在定点运算中，这是不允许的，但是在浮点运算中，可以进行右规消除溢出

**舍入**
在进行对阶和右规的过程中，可能会将尾数低位丢失，影响精度，可用舍入法提高尾数精度

- 0舍1入法：在原码中，当被移去的最高位为0时，这舍去，当最高位为1时，在尾数的末尾加一；在补码中情况可能不一样，单遵循的原则不变——舍去使得绝对值变小，进位使得绝对值变大
- 恒置1法：无论是原码和补码都是在末尾置1（不是加一），对于补码，该方法可以将误差控制在最后一位

**溢出判断**
浮点数溢出和定点数溢出定义不一样——浮点数溢出，是指阶码的溢出
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680660098453-3c4c2536-2b98-403d-a091-59e016c7e141.png#averageHue=%23f3f3f3&clientId=u256978bf-41aa-4&from=ui&height=147&id=u06b8ca6e&originHeight=248&originWidth=1177&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=57110&status=done&style=none&taskId=ued35cfb9-353a-4457-80b8-3ccec398726&title=&width=700" width="700" /> </div>
...
### 浮点数乘除运算
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680660616091-ec93e6d2-f055-453d-85a5-3b680afcac61.png#averageHue=%23f5f5f5&clientId=u256978bf-41aa-4&from=ui&height=143&id=u644c0ad2&originHeight=229&originWidth=1118&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=21425&status=done&style=none&taskId=ue834af89-36f4-4bba-a600-1f340d43f9a&title=&width=700" width="700" /> </div>
...
- 截断法：处理简单，影响精度
- 舍入处理：对于原码和正数补码，0舍1如，对于负数补码，采取以下处理规则：
> 负数补码加一相当于让绝对值变小，舍去相当于让绝对值变大

   - 丢失的各位全为0，不舍入——（全为0没影响，不用处理）
   - 丢失最高位为0，以下各位不全为0，或者最高位为1，之后各位全为0，则舍弃被丢失的各位——这两种情况，丢失的绝对值大，此时不加一，相当于让绝对值增大
   - 丢失最高位为1，以下各位不全为0，尾数末尾加一——丢失的绝对值小，此时加一让尾数绝对值变小


## 6.5 算术逻辑单元
### ALU电路
以下为ALU框图，A和B为两个操作数，K指定运算类型，F为输出
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680662964903-039ce57c-ea69-4015-8dfd-6aa2d8e9b429.png#averageHue=%23f7f7f7&clientId=u256978bf-41aa-4&from=ui&height=168&id=u5ce1ed2f&originHeight=280&originWidth=499&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=4279&status=done&style=none&taskId=u8a78c237-f000-4be6-95ec-aae6eaabf4f&title=&width=300" width="300" /> </div>


74LS181为四位ALU，其引脚图和功能表参考教材
### 快速进位链
**并行加法器**
串行加法器是由当个全加器组成的加法器，数据逐位串行送入加法器进行运算（也就是用一个全加器一位一位的进行运算）
并行加法器由多个全加器组成，其全加器个数的多少取决于机器的字长，由于并行加法器可同时对数据的各位相加，各位是否能同时产生结果取决去采用的进位链

**串行进位链**
全加的逻辑表达式如下：
$S_i=A_i\oplus B_i\oplus C_{i-1}$
$Ci=A_iB_i+\left( A_i+B_i \right) C_{i-1}$
进位$Ci$由两部分组成：本地进位$d_i=A_iB_i$，传递进位$\left( A_i+B_i \right) C_{i-1}$，成$t_i= A_i+B_i$为传递条件，则有$Ci=d_i+t_iC_{i-1}$
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680664944321-e9f5129d-1730-4388-a8e3-7800dd46ebfb.png#averageHue=%23f6f6f6&clientId=u256978bf-41aa-4&from=ui&height=142&id=u1b63a335&originHeight=237&originWidth=501&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=10196&status=done&style=none&taskId=ufe6cbf3d-acda-48c1-902a-ecc1d0104e5&title=&width=300" width="300" /> </div>


以四位加法器为例，采用串行进位链的电路如下
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680664783626-aeb0fb84-b018-4b0c-8514-0f0119cdcfa4.png#averageHue=%23eeeeee&clientId=u256978bf-41aa-4&from=ui&height=127&id=u1204737c&originHeight=201&originWidth=1107&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=9733&status=done&style=none&taskId=ud86c1e22-483d-46cc-b852-42a0ab65aee&title=&width=700" width="700" /> </div>


设与非门的级延迟时间为$t_y$，$n$为加法器最长进位时间为$2n\ t_y$

**并行进位链**
并行进位链是指并行加法器中进位信号是同时产生的，也成为先行进位、跳跃进位，有两种实现方式

1. 单重分组跳跃进位

将n为全加器分为若干小组，小组内的进位同时产生，小组之间采用串行进位，以四位并行加法器为例
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680665076077-f3a4b3fa-0904-458e-a86f-612d735339fb.png#averageHue=%23f4f4f4&clientId=u256978bf-41aa-4&from=ui&height=156&id=u551438a6&originHeight=247&originWidth=793&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=39552&status=done&style=none&taskId=ua5ac2d5b-400a-4159-9be3-767d3080ec8&title=&width=500" width="500" /> </div>


小组内的每个进位的产生只与输入小组的最低位进位有关，采取以下电路实现并行进位
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680665292275-20a3cb34-ff41-4b7b-a718-f72ef22b71cc.png#averageHue=%23f2f2f2&clientId=u256978bf-41aa-4&from=ui&height=302&id=ue2185616&originHeight=533&originWidth=1236&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=126084&status=done&style=none&taskId=u6776d8ec-2ed4-43bc-8031-0c2f00f8c43&title=&width=700" width="700" /> </div>


假设与或非门即延迟时间为$1.5t_y$，小组内只需要$2.5t_y$就能产生全部进位

2. 双重分组跳跃进位

基本思路是——将全加器分为若干大组，大组中有分为若干小组，小组内部以及小组之间并行产生进位，大组之间串行传递进位
对于一个大组中的每个小组，其最高位进位的逻辑表达式如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680665920668-3b466164-3d8b-4d22-88b3-920089fb29d5.png#averageHue=%23f5f5f4&clientId=u256978bf-41aa-4&from=ui&height=386&id=u735fbdfe&originHeight=1190&originWidth=1850&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=112818&status=done&style=none&taskId=uc3667ee6-465f-48f8-8423-50305ed9e77&title=&width=600" width="600" /> </div>


发现小组之间可以采用类似小组内部多个全加器 采用的并行进位策略，进位电路如下
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680666160456-8e9f80e3-05c7-4ca7-b747-b09deca9a0bf.png#averageHue=%23f1f1f1&clientId=u256978bf-41aa-4&from=ui&height=340&id=ufb9d73df&originHeight=608&originWidth=1250&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=147992&status=done&style=none&taskId=uc12c3e51-cdee-4526-b48a-51ea062524c&title=&width=700" width="700" /> </div>


D和T的产生，由于小组内部的同步进位电路得出：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680666275414-e4973fad-7606-438f-98a1-b46b00cb1347.png#averageHue=%23efefef&clientId=u256978bf-41aa-4&from=ui&height=356&id=u96c7e1b4&originHeight=549&originWidth=1080&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=107335&status=done&style=none&taskId=u67727e7d-30bb-465d-a7f0-1665f0c1658&title=&width=700" width="700" /> </div>


现对一个$n=32$的双重进位进行分析：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1680666385731-bd7ebcbd-1616-4695-9878-8e5d3f1ca118.png#averageHue=%23e4e4e4&clientId=u256978bf-41aa-4&from=ui&height=316&id=ud941ed7a&originHeight=776&originWidth=1718&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=56432&status=done&style=none&taskId=u251d8ab5-dad1-4c15-9301-9b48e646dee&title=&width=700" width="700" /> </div>



- 经过$2.5t_y$：产生所有的D和T信号、以及最低位的$C_{2-0}$进位信号
- 经过$2.5t_y$：产生第二大组中所有小组的最高位进位信号
- 经过$2.5t_y$：产生第一大组中所有小组的最高位进位信号、产生第二大组所有进位信号
- 经过$2.5t_y$：产生第一大组所有进位信号

可以发现经过$10t_y$就能产生所有进位信号（是从产生d和t信号之后开始计算）

# 第7章 指令系统
## 7.1 机器指令
### 7.1.1 指令格式
指令是由操作码和地址码两部分组成的
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681180412821-9a0053f1-3efd-4f54-a72d-1d53d50c4519.png#averageHue=%23e0e0e0&clientId=u5eaf5b5f-bd65-4&from=ui&height=61&id=uda5a3476&originHeight=118&originWidth=975&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=9003&status=done&style=none&taskId=u4da824bb-8ff2-47d8-86ad-00fdff4e36d&title=&width=500" width="500" /> </div>


**操作码**
指明指令完成的操作，操作码长度：

- **长度固定**：便于硬件设计，指令译码时间短，广泛用于字长较长的、中大型就三级和超级小型计算机以及RISC。
- **长度可变**：有效压缩了操作码的平均长度，在字长较短的微型计算机中广泛采用，增加了指令译码和分析的难度，控制器设计复杂，通常采用拓展操作码技术。

**拓展操作码技术**
操作码的长度随着地址数的减少而增加，任何短操作码不能是长操作码的前缀，可以在短操作码中留出一种，作为长操作码的前缀（例如，下图中选“1111”）
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681180717434-4c5579d0-b344-49c0-8b76-9c649ef91c43.png#averageHue=%23eeeded&clientId=u5eaf5b5f-bd65-4&from=ui&height=447&id=uac7ae8cb&originHeight=1003&originWidth=1345&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=89313&status=done&style=none&taskId=ue32be7bb-df5c-424a-9ab5-5cd340aa0fb&title=&width=600" width="600" /> </div>
...
四个地址分别是：第一个操作数地址、第二个操作数地址、结果存放的地址、下一条指令的地址。一共需要4次访存（取指令、取两个操作数、存放结果）。
程序中的指令大多是按照顺序执行的，PC能存放当前欲执行的指令的地址，同时可以计数，可以自动生成下一条指令的地址，因此指令的地址部分可以省去下一条指令的地址。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681383786651-45d2e266-a7bb-4c3d-b9cb-6fb56423d74e.png#averageHue=%23ebeaea&clientId=u16ef27c2-a3f5-4&from=ui&height=236&id=u3d197c55&originHeight=605&originWidth=769&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=39683&status=done&style=none&taskId=ua3d70d10-c5d9-4b9e-886d-80b59e6d2df&title=&width=300" width="300" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681383858327-5ed02954-37ae-478f-bcbd-239b0d3a5b1c.png#averageHue=%23e8e8e7&clientId=u16ef27c2-a3f5-4&from=ui&height=123&id=ud8e4ffcb&originHeight=306&originWidth=748&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=8467&status=done&style=none&taskId=u4fff6377-2054-4350-9aca-ba00099296d&title=&width=300" width="300" /> </div>



- 二地址指令

存放操作的内存可以存放结果，可以减少一个地址得到二地址指令，如果结果是存放在寄存器ACC中，则只需要3次访存（取指令、取两个操作数）。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681383912636-77f15790-4ee8-4dcc-b156-4df0ed3c8506.png#averageHue=%23f1f0f0&clientId=u16ef27c2-a3f5-4&from=ui&height=184&id=ua3b8bd91&originHeight=524&originWidth=856&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=23817&status=done&style=none&taskId=uf36a69be-996b-4eff-8a54-22c80b60b08&title=&width=300" width="300" /> </div>



- 一地址指令

ACC既可以存发结果，也可以存发一个操作数（当前操作数可以上一次运算的结果），一次只需要一个地址（操作数地址），一共需要2次访存（取指令、取一个操作数）。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681383942334-3e2ee765-3323-4df9-beb5-bdbbe93a0904.png#averageHue=%23ececeb&clientId=u16ef27c2-a3f5-4&from=ui&height=105&id=u67ce03da&originHeight=298&originWidth=852&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=8139&status=done&style=none&taskId=u4e40bded-706b-45dc-a329-9373791f275&title=&width=300" width="300" /> </div>



- 零地址指令

指令中没有地址码，如空操作（NOP）、停机（HLT）没有操作数，而子程序返回（RET）、中断返回（IRET）的操作数地址隐含在堆栈指针SP中。
...
早期计算机指令字长、机器字长和存储字长相等，指令字长固定，控制方式比较简单。

- 指令长度按字节倍数变化

现在计算机的指令系统可以采用不同位数的指令，控制电路比较复杂，多字长指令需要多次访存才能取出完整指令，为了提高指令运行速度和节省存储空间，尽可能把常用的指令（如，数据传送指令、算逻辑运算指令）设计成单字长或短字长格式指令。
## 7.2 操作数类型和操作类型
### 7.2.1 操作数类型
机器中常见的操作数类型有以下：
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681211304194-b1ff5aef-4703-454e-9b66-eefb29ac5667.png#averageHue=%23e9e9e9&clientId=u0d5129d1-0558-4&from=ui&height=143&id=ube79bdc5&originHeight=285&originWidth=1198&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=24338&status=done&style=none&taskId=ue68cd2d0-8fbf-4186-8f87-cc6d64584bc&title=&width=600" width="600" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681211611769-73b27e6f-69d8-4aed-88d7-4cf0016baf63.png#averageHue=%23f1f0f0&clientId=u0d5129d1-0558-4&from=ui&height=129&id=u8192075f&originHeight=227&originWidth=1233&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=14329&status=done&style=none&taskId=ue34dc5c4-3847-49a0-b17e-65bf030baf7&title=&width=700" width="700" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681211733898-5e80fe00-5b3c-42a7-911a-b58ccc3b0aab.png#averageHue=%23b5b5b5&clientId=u0d5129d1-0558-4&from=ui&height=147&id=u7343c4c1&originHeight=253&originWidth=1201&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=9428&status=done&style=none&taskId=ufa9562e4-9c22-4b24-aeb5-3ef4c342351&title=&width=700" width="700" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681211907223-45c71a26-ee21-412d-9e6b-90a03538a70b.png#averageHue=%23e7e6e6&clientId=u0d5129d1-0558-4&from=ui&height=172&id=u12331058&originHeight=314&originWidth=1278&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=31062&status=done&style=none&taskId=u7809ba24-5ee0-4e45-bc11-2c33b48abfd&title=&width=700" width="700" /> </div>


### 7.2.3 操作类型
不同的机器操作类型不同，但是几乎所有机器都有以下几种通用操作：
**数据传送**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681212237015-4c09122d-bc6c-44db-a47d-1b5eed96dd8f.png#averageHue=%23f4f4f3&clientId=u0d5129d1-0558-4&from=ui&height=153&id=ufaccf96d&originHeight=291&originWidth=954&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=22704&status=done&style=none&taskId=u481486ca-bb35-4891-910c-8eb679da34b&title=&width=500" width="500" /> </div>
...
根据当前指令执行结果来决定是否需要转移，一般机器能够提供一些条件码，例如，零标志位`Z`、负标识位`N`、溢出标志位`V`、进位标志位`C`、奇偶标志位`P`，为偶数时`P=1`，其他标志位当满足对应条件时均为1
`SKP DZ` 表当触发器D为零时，跳过一条指令

- 调用与返回

调用指令`CALL`与返回指令`RETURN`配合使用
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681213019727-7005c2ef-bf27-4d10-830a-1dbe797362f4.png#averageHue=%23f7f7f7&clientId=u0d5129d1-0558-4&from=ui&height=426&id=u8250d142&originHeight=730&originWidth=1027&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=42962&status=done&style=none&taskId=ub319b4ad-f150-4433-960f-a82c86f4294&title=&width=600" width="600" /> </div>



- 陷阱指令

陷阱Trap是一种意外事故的中断，此时计算机发出陷阱指令，暂停当前程序的执行，转入故障处理程序进行故障处理。一般不提供给用户使用，作为隐指令（指令系统中不提供的指令），但是有些机器设置供给用户使用陷阱指令，用来完成系统调用。

**输入输出**
对于IO单独编址的计算机，通常设置输入输出指令，完成数据在寄存器和外部IO设备之间的转移，IO设备和内存一起编址的计算机，不需要输入输出指令，使用转移指令完成对应操作。
## 7.3 寻址方式
### 7.3.1 指令寻址
指令寻址比较简单，分为顺序寻址、跳跃寻址

- 顺序寻址：通过PC加一（加多少取决地址编码方式），自动形成下一条指令地址
- 跳跃寻址：通过转移类指令来实现
### 7.3.2 数据寻址
数据寻址类型较多，指令字段中需要一个字段来指明寻址的方式，指令的地址码不一定代表真实地址，称为形式地址，记作A，操作数的真实地址称为有效地址，记作EA
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681219654588-a3da2987-54fd-4176-8d62-b4fda00f12e6.png#averageHue=%23dddddd&clientId=u1fd3df50-1680-4&from=ui&height=42&id=ucd4aa2d8&originHeight=136&originWidth=1285&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=12773&status=done&style=none&taskId=u0820d12a-4f70-4939-83a8-6ceb698882f&title=&width=400" width="400" /> </div>
...
**隐含寻址**
寻址标志位隐含表示操作数在某个寄存器中。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681219988854-27c382fc-dad6-463b-8909-0f7597d84457.png#averageHue=%23edecec&clientId=u1fd3df50-1680-4&from=ui&height=284&id=u06f1805b&originHeight=869&originWidth=1530&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=98426&status=done&style=none&taskId=ufafbda35-aeee-40ab-8da6-3c52809ac41&title=&width=500" width="500" /> </div>



**间接寻址**
形式地址指向的存储单元中存储的是有效地址，即`EA=(A)`。扩大了寻址范围；便于编制程序，例如用间接寻址很容易实现子程序的返回，在主程序中多次调用自程序时，不需要修改子程序指令，而是修改`(A)`即可。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681259455363-64101074-ae06-4510-b34c-68b6baa2bf37.png#averageHue=%23f7f7f7&clientId=u90ee4fd1-e5d0-4&from=ui&height=312&id=ub3ba1876&originHeight=1012&originWidth=1623&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=64287&status=done&style=none&taskId=u51d45b43-498c-44f8-aa12-1f7dab7333b&title=&width=500" width="500" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681259761983-30238d73-b151-49a9-81a5-93b4e4d1fd95.png#averageHue=%23f7f7f6&clientId=u90ee4fd1-e5d0-4&from=ui&height=281&id=u8bb9f853&originHeight=746&originWidth=1326&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=25446&status=done&style=none&taskId=u476340be-7a98-4f0b-b186-a3f2c818492&title=&width=500" width="500" /> </div>
...
**基址寻址**
设有基址寄存器`BR`，`EA=A+(BR)`。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681260063905-b2beb1c7-f374-47df-bf0f-f66df150305d.png#averageHue=%23f2f2f2&clientId=u90ee4fd1-e5d0-4&from=ui&height=227&id=u12ff583b&originHeight=587&originWidth=1293&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=22785&status=done&style=none&taskId=u4776e329-6656-4e86-a8cf-7072146315f&title=&width=500" width="500" /> </div>
...
**相对寻址**
有效地址由PC的值和形式地址相加得出，`EA=A+(PC)`。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681260752971-1f307b1a-f37a-4273-ab8e-af54a14f975e.png#averageHue=%23f3f3f3&clientId=u90ee4fd1-e5d0-4&from=ui&height=202&id=ue4f140dc&originHeight=679&originWidth=1684&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=37490&status=done&style=none&taskId=u3107839e-4bb7-4b92-8856-7e3279efbc1&title=&width=500" width="500" /> </div>


特点在于转移地址不固定，无论程序在主存哪个区域，都可以正确运行，对于编写浮动程序有利；广泛用于转移指令。需要注意形式地址的设置问题，执行当前指令时，PC的值已经加一。

**堆栈寻址**
要求计算机中设有堆栈。堆栈中数据先进后出，栈顶为低地址，栈底为高地址，用堆栈指针`SP`Stack Point指出栈顶地址。
> 硬堆栈：用寄存器组来实现
> 软堆栈：用主存的一部分来实现

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681261283917-b51e0a72-a0ad-44ed-a370-18d4e903ac6d.png#averageHue=%23efefef&clientId=u1776a8ba-823c-4&from=ui&height=281&id=u225c0ec6&originHeight=411&originWidth=586&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=22193&status=done&style=none&taskId=u222684ca-2a3d-4385-ac19-cf3e82130ba&title=&width=400" width="400" /> </div>


进栈则`(SP)+1——>SP`，出栈则`(SP)-1——>SP`。进出栈不一定是加一减一，取决于主存编制方式。
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681262027495-acaf6e03-16b4-4ebf-9dde-6b24840b185f.png#averageHue=%23f5f5f5&clientId=u1776a8ba-823c-4&from=ui&height=353&id=u729caf39&originHeight=510&originWidth=1010&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=94993&status=done&style=none&taskId=u08ac12f3-c7bf-4838-aad0-d9798c03977&title=&width=700" width="700" /> </div>



**Intel 8086**
指令字长不定长，为1-6个字节。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681262375727-ff8d0614-8bb1-4a75-a9be-cf3d43ca2a4e.png#averageHue=%23f0efef&clientId=u1776a8ba-823c-4&from=ui&height=66&id=u430b0025&originHeight=190&originWidth=1431&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=14968&status=done&style=none&taskId=u8941f999-e68c-4b52-8e20-c6fc5c8367a&title=&width=500" width="500" /> </div>


地址格式如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681262458154-be37203b-04a2-4563-9c2d-d40845d5528f.png#averageHue=%23f4f3f3&clientId=u1776a8ba-823c-4&from=ui&height=192&id=uebeacc32&originHeight=648&originWidth=1688&originalType=binary&ratio=1.3499999046325684&rotation=0&showTitle=false&size=69871&status=done&style=none&taskId=u4c23a5ec-bdc8-46a2-85e0-c00bc134fcd&title=&width=500" width="500" /> </div>


## 7.5 RISC技术
### 7.5.1 RISC的发展
早期为了简化编译器的任务，缩小机器指令和高级语言之间的差距，产生了增加复杂指令的办法；后来发现，如果编译器过多依赖复杂指令，对减少机器代码、降低指令执行数和提高流水性能不利。
由于典型程序中 80% 的语句仅仅使用处理机中 20% 的指令，RISC的产生就是用 20% 的简单指令组合不常用的80% 的指令功能。
### 7.5.2 RISC的主要特征
...
商品化的RISC机器通常不会是纯RISC机器，以上特点并不是所有RISC机器都具备。
### 7.5.3 CISC主要特征
...
## 8.1 CPU结构
### 8.1.1 CPU功能
CPU实质包含运算器和控制器两大部分，运算器在第6章已经提及，这里侧重于控制器的功能。
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681392502555-f8975c1c-e93b-4dfd-aab9-5b44757ac169.png#averageHue=%23e8e8e7&clientId=u16ef27c2-a3f5-4&from=ui&height=211&id=uc34fbc5d&originHeight=483&originWidth=916&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=31600&status=done&style=none&taskId=u22a96fe7-14d8-411e-83be-f422bdd6c00&title=&width=400" width="400" /> </div>
...
- 组合逻辑设计方式：硬连线逻辑，速度快，RISC的CU使用该方式。
...
## 8.2 指令周期
### 8.2.1 基本概念
指令周期——CPU取出一条指令并完成执行所需的全部时间，可大致分为两个阶段：

- 取指阶段：从存储器取出指令，并分析指令。
- 执行阶段：取操作数，进行运算，结果写入内存等。

不同指令的指令周期是不同的，如下图：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681393580203-f0797172-970b-4a6a-94e2-c07cecc82b2f.png#averageHue=%23f6f5f5&clientId=u16ef27c2-a3f5-4&from=ui&height=267&id=u6673c4c5&originHeight=758&originWidth=1420&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=50457&status=done&style=none&taskId=u6aa32884-84de-4d7b-a3e4-992b06526da&title=&width=500" width="500" /> </div>


采用间接寻址或执行中断的指令还有间址周期和中断周期：
例如，当CPU采用中断方式和IO交换信息时，在每条指令执行阶段结束之前需要发出中断查询指令，当有中断请求时，就进入中断周期以响应中断。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681393768067-a5a9f97e-2fac-4929-a8ef-ea7111118f81.png#averageHue=%23efefee&clientId=u16ef27c2-a3f5-4&from=ui&height=199&id=u0341d60b&originHeight=518&originWidth=1563&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=83316&status=done&style=none&taskId=u17ae7682-fa69-4144-af33-a61a14f9893&title=&width=600" width="600" /> </div>



### 8.2.2 指令周期的数据流
**取值周期**
根据PC中的地址，从内存取出指令送到IR，最后要将PC增加一。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681454766462-a9af0469-5b50-4961-bf0d-dc921781c433.png#averageHue=%23f3f3f3&clientId=u44250e62-9ad3-4&from=ui&height=242&id=u6ab6eab9&originHeight=409&originWidth=1012&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=76400&status=done&style=none&taskId=ufcc47ce3-a7f0-4f64-9abe-b5f85565179&title=&width=600" width="600" /> </div>


**间址周期**
将MDR中形式地址部分送到MAR进行处理。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681454981940-e77aa40d-4773-4899-ade4-c390ed31e503.png#averageHue=%23f4f4f4&clientId=u44250e62-9ad3-4&from=ui&height=234&id=ud3d26e68&originHeight=403&originWidth=1033&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=78225&status=done&style=none&taskId=ue4e0b682-335a-435b-9f65-ab938f80645&title=&width=600" width="600" /> </div>
...
**中断周期**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681455188397-1e21c20b-08fe-40f3-a7ad-ba2dbcbf4bdb.png#averageHue=%23f3f3f3&clientId=u44250e62-9ad3-4&from=ui&height=215&id=u0b1f6f51&originHeight=393&originWidth=1095&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=107487&status=done&style=none&taskId=ub69dfdaa-9981-4473-a411-5ba3f5d8faa&title=&width=600" width="600" /> </div>




## 8.3 指令流水
为了提高计算机速度，一方面可以提期间的性能；另一方面可以改进系统的结构，开发系统的并行性。
并行包含两重含义：
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681456013329-21a95110-7e40-44e9-9748-77f1eb1b3a66.png#averageHue=%23dddddd&clientId=u44250e62-9ad3-4&from=ui&height=49&id=uad6b0b5e&originHeight=141&originWidth=1724&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=11119&status=done&style=none&taskId=u680df38b-960b-44bf-a103-ddd9da49589&title=&width=600" width="600" /> </div>


可以看出在任一时刻总是有取值部件或指令执行部件空闲，为了提高效率，可以让两条指令重叠，即指令的二级流水：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681456151361-83d92ded-63f1-49d2-b9fa-0ca502be9178.png#averageHue=%23efefef&clientId=u44250e62-9ad3-4&from=ui&height=114&id=ua10d83e6&originHeight=287&originWidth=1512&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=24923&status=done&style=none&taskId=ue8fcb867-b575-4846-b750-e84d223efc3&title=&width=600" width="600" /> </div>
...
指令可以形成六级流水：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681456787854-51a468e0-0ef3-4c2b-a308-f26780bcdb9f.png#averageHue=%23f0f0f0&clientId=u44250e62-9ad3-4&from=ui&height=264&id=uc880d73e&originHeight=599&originWidth=1588&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=58818&status=done&style=none&taskId=u168d0eff-2a03-48ff-b6c8-5eb120c4606&title=&width=700" width="700" /> </div>



### 8.3.2 影响流水线性能因素
**结构相关**
不同指令争夺同一功能部件产生的资源冲突。例如，FI、FO、WO都需要访存，可能会发生发出冲突，如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681457015698-79221273-30a2-4230-b89d-203684c70007.png#averageHue=%23f1f1f1&clientId=u44250e62-9ad3-4&from=ui&height=273&id=uf94b42ee&originHeight=641&originWidth=1526&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=60936&status=done&style=none&taskId=u5e0457c4-444e-481f-8a7e-5d9c5f14731&title=&width=650" width="650" /> </div>


解决方法：

- 停顿：将指令的操作暂停一段时间（例如一个周期）后再执行。
- FI和FO的冲突，可以设置两个独立指令Cache和数据Cache，即指令存储和数据存储分开，这种结构被称为哈佛结构(Harvard architecture)。
- 指令预取技术：将指令预先取到一个队列里面，避免FI和FO的冲突，适用于访存周期短的场景。
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681457511083-aba0dd3f-079f-4506-9a85-67e83301b11e.png#averageHue=%23f2f1f1&clientId=u44250e62-9ad3-4&from=ui&height=72&id=u8316d3cb&originHeight=176&originWidth=1217&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=12783&status=done&style=none&taskId=u4833b066-0ec9-4942-a199-b639f358dc2&title=&width=500" width="500" /> </div>



- 读后写相关

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681457544732-7bad240e-d5a3-41b0-b98c-16aaf941585a.png#averageHue=%23f1f1f0&clientId=u44250e62-9ad3-4&from=ui&height=65&id=ud41211e3&originHeight=165&originWidth=1267&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=15928&status=done&style=none&taskId=u52a7cb7a-42e8-4908-a58f-6cc39c020db&title=&width=500" width="500" /> </div>



- 写后写相关

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681457572506-49a1f406-98e8-490e-b28b-582b0f499741.png#averageHue=%23f2f1f1&clientId=u44250e62-9ad3-4&from=ui&height=64&id=uf3ad57b9&originHeight=162&originWidth=1262&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=13145&status=done&style=none&taskId=ud5f1b8cb-331d-4d5d-bd89-368587d6438&title=&width=500" width="500" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681457850138-a9ee7d97-e6a6-4c9a-aad8-fcc8ea3c20c6.png#averageHue=%23f2f2f2&clientId=u44250e62-9ad3-4&from=ui&height=256&id=ueb0b5738&originHeight=654&originWidth=1532&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=57292&status=done&style=none&taskId=u020cc39d-a945-4b73-a2fb-acb65a61c04&title=&width=600" width="600" /> </div>


解决方法：

- 尽早判别转移是否发生，尽早生产转移目标地址。
- 如果无法提前判断，预取成功和成功两个控制流方向上的目标指令。
- 加快和提前形成条件码。
...
### 8.3.4 流水线的多发技术
**超标量技术**
超标量（superscalar）技术是指每个时钟周期内可同时并发多条独立指令，要求配置多个功能部件和指令译码电路、多个寄存器端口和总线。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681459058238-71f58f7c-fa34-4a41-85fb-1d89c1caf55f.png#averageHue=%23ebebeb&clientId=u44250e62-9ad3-4&from=ui&height=173&id=u2c4f823a&originHeight=524&originWidth=1516&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=23090&status=done&style=none&taskId=u629f16b0-b04e-4f87-8ef1-30d67f8fe21&title=&width=500" width="500" /> </div>


超标量计算机不能挑战指令执行顺序，但是可以通过编译优化技术，并能并行的指令搭配起来。

**超流水技术**
超流水技术（superpipeline）是将一些流水线寄存器插入流水线段中，将流水线再分段。在一个时钟周期内将一个功能部件使用多次。
同样不能改变指令执行顺序，通过编译进行优化。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681459336215-c01392ad-a582-48a8-8b1e-7b8639510a1c.png#averageHue=%23eaeaea&clientId=u44250e62-9ad3-4&from=ui&height=182&id=ueb0e7d3e&originHeight=541&originWidth=1489&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=22821&status=done&style=none&taskId=u2cd9e421-8bcd-45cf-8fe8-d34cee7e9c1&title=&width=500" width="500" /> </div>



**超长指令字技术**
超长指令字技术（VLIW）和超标量技术都是采用多条指令能在多个处理部件中并行处理的结构。超标量的指令来自标准的指令流，VLIW是在编译时挖掘出指令之间的并行性后，把能并行的指令合并为一条具有多个操作码字段的超长指令。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681459644410-4095bae9-47d0-4369-9186-8b67b1805c8c.png#averageHue=%23eeeded&clientId=u44250e62-9ad3-4&from=ui&height=185&id=udb166468&originHeight=580&originWidth=1564&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=24318&status=done&style=none&taskId=udd34ff2a-5e8c-407f-82dc-292e11c41db&title=&width=500" width="500" /> </div>



### 8.3.5 流水线结构
**指令流水线结构**
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681460227004-20e70d3e-6ec9-404f-8ff8-714d5e92a775.png#averageHue=%23e0e0e0&clientId=u44250e62-9ad3-4&from=ui&height=159&id=u1e099062&originHeight=423&originWidth=1067&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=44117&status=done&style=none&taskId=u9d90d76a-ab43-4907-9286-43d6ed26142&title=&width=400" width="400" /> </div>


在流水线每个操作部件的后面，都要有一个缓冲寄存器（锁存器），称为流水寄存器，这个缓冲寄存器用于保存本阶段的执行结果，以保证各个部件之间的速度是匹配。

**运算流水线**
流水线技术还可以用于部件级别，例如浮点数的加法运算也可以进行流水线工作：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681460550686-341f4c49-f873-436d-a59b-5a64f76d1b1e.png#averageHue=%23e8e8e8&clientId=u44250e62-9ad3-4&from=ui&height=184&id=u67227544&originHeight=503&originWidth=1092&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=39251&status=done&style=none&taskId=uc4dcb739-fd25-4476-b2cc-6fa0d21a480&title=&width=400" width="400" /> </div>
...
引起中断的因素称为中断源。中断源可以分为不可屏蔽中断，如电源掉电，和可屏蔽中断。
...
### 8.4.2 中断请求标记和判优逻辑
**中断请求标记**
中断请求触发器INTR为1表示有中断请求，多个触发器集成在CPU内部形成中断请求标记寄存器，如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681867759676-c7569bbb-4145-4f00-a4e5-c20abdaf1a8c.png#averageHue=%23f3f3f3&clientId=u990588e7-ab07-4&from=ui&height=151&id=uad1f9289&originHeight=512&originWidth=1693&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=42628&status=done&style=none&taskId=ub196ad7f-9c82-439d-b2b6-6b9a876fa05&title=&width=500" width="500" /> </div>
...
一种为链式排队器，对应INTR分散在各个中断源的情况，参考[IO程序中断方式](#N5Jhi)。另一种排队器设在CPU内部，结构如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681868068475-5a1a267b-fd50-4dd7-9711-347f6f195ca6.png#averageHue=%23f5f5f5&clientId=u990588e7-ab07-4&from=ui&height=197&id=ue113a57a&originHeight=586&originWidth=1784&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=20732&status=done&style=none&taskId=u94704278-551e-4d53-9844-9f92d199f2b&title=&width=600" width="600" /> </div>
...
通过编写查询程序实现。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681868145515-0ff629a5-81a4-47b4-8a2e-024369005f6d.png#averageHue=%23f7f7f7&clientId=u990588e7-ab07-4&from=ui&height=296&id=u375c2b3f&originHeight=852&originWidth=1440&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=74059&status=done&style=none&taskId=ud6a69002-dbeb-4295-a347-b13f35bf830&title=&width=500" width="500" /> </div>
...
通常有两种方式，向量地址内存单元放置的是：无条件转移指令，或者设置向量表，存储单元内容为入口地址。
硬件向量法寻找入口地址速度快，在现代计算机被普遍采用。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681876897312-f2b4ac51-2ee3-4f95-8efa-afccd0f5120e.png#averageHue=%23eeeeed&clientId=u990588e7-ab07-4&from=ui&height=216&id=Lsjzv&originHeight=542&originWidth=1507&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=68653&status=done&style=none&taskId=u66487a46-76d4-4d70-bacd-c29c5befc22&title=&width=600" width="600" /> </div>
...
### 8.4.4 中断响应
**响应中断的条件**
CPU能够响应中断的条件是 允许中断触发器`EINT` 为1。

**响应中断的时间**
CPU总是在指令执行周期结束后，响应中断。在一个指令的执行周期结束后，统一向中断源发送查询信号，如果有中断就进行响应。
某些计算机中有些指令的执行时间很长，可在指令执行周期过程中设置若干个查询端点。

**中断隐指令**
中断隐指令是机器指令系统中没有的指令，在中断周期中硬件自动完成的一条指令。具体操作如下：

- 保护程序断点

将当前程序计数器`PC`的内容保存到存储器。可以存入在存储器的特定单元（0号地址）或者存入堆栈。
...
单重中断开始响应中断时就关中断，避免受到其他中断源的影响。以下为硬件关中断的示意图：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681885120633-e75e1c93-4c16-4e38-8567-626f89072d4a.png#averageHue=%23eeeeed&clientId=u612ee6b7-a8c6-4&from=ui&height=224&id=u9d79aa21&originHeight=613&originWidth=1093&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=24099&status=done&style=none&taskId=udcb5c903-f371-4ef4-a459-951f2a802a6&title=&width=400" width="400" /> </div>
...
- 程序断点（PC的内容）：由中断隐指令完成。
- 保护CPU内部各寄存器的内容：在中断服务程序中由用户或系统用机器指令编程实现。
...
**屏蔽技术**
排队器分散在接口上时，单个中断请求接口电路如下，只有屏蔽触发器为`MASK`为0时才能发出中断请求。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1679406023280-5e2ca268-aac3-4675-a61a-e95066ab07c1.png#averageHue=%23f5f5f5&from=url&height=282&id=AVbpU&originHeight=884&originWidth=940&originalType=binary&ratio=1.5&rotation=0&showTitle=false&status=done&style=none&title=&width=300" width="300" /> </div>


排队器集成在CPU内部时，加上屏蔽条件，组成具有屏蔽功能的排队器：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681886148051-e7f4ed5c-e681-43ee-8fab-80508b498684.png#averageHue=%23eeeeee&clientId=uc48e09f0-ef63-4&from=ui&height=260&id=u3c239d30&originHeight=630&originWidth=970&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=17597&status=done&style=none&taskId=u65986793-82df-490a-8377-b4da59a630c&title=&width=400" width="400" /> </div>


将所有屏蔽触发器组合在一起，构成一个屏蔽寄存器，屏蔽寄存器的内容称为屏蔽字。屏蔽字和中断源的优先级是一一对应的，如下图：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681994106269-6d62449f-b0af-4348-8452-e01fe3d2d5c8.png#averageHue=%23f5f5f5&clientId=u17ab101e-fff4-4&from=ui&height=264&id=u18ac1b16&originHeight=856&originWidth=1619&originalType=binary&ratio=1.6500000953674316&rotation=0&showTitle=false&size=37178&status=done&style=none&taskId=u75b03214-8f07-46f2-bc59-0b2a78dc98c&title=&width=500" width="500" /> </div>
...
- 响应优先级是CPU响应各中断源请求的优先次序，一般是硬件线路设置，不便于改动。
- 处理优先级是CPU实际对中断源的处理的优先次序。屏蔽技术可以给中断源设置屏蔽字来改变中断源的处理优先级。

假设现在有4个中断源，响应优先级为$A\rightarrow B\rightarrow C\rightarrow D$，CPU执行中断程序过程如下图：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681994753179-3c59ec83-a8e9-44f3-930f-bbf93791d3b7.png#averageHue=%23f7f7f7&clientId=u17ab101e-fff4-4&from=ui&height=233&id=u14f2ebee&originHeight=556&originWidth=1432&originalType=binary&ratio=1.6500000953674316&rotation=0&showTitle=false&size=38523&status=done&style=none&taskId=u1f43d1a3-4773-47fd-9596-fd01d69708a&title=&width=600" width="600" /> </div>


对中断源的屏蔽字进行修改：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681994884644-5f8e0151-db84-4c32-afc9-a66ce1adfde9.png#averageHue=%23ededed&clientId=u17ab101e-fff4-4&from=ui&height=149&id=u03ba85ac&originHeight=387&originWidth=1302&originalType=binary&ratio=1.6500000953674316&rotation=0&showTitle=false&size=20167&status=done&style=none&taskId=ue7826fe4-bfb9-4817-9051-59ffd0a9f6f&title=&width=500" width="500" /> </div>


此时CPU执行过程如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1681995113327-bde079e6-4991-40d0-8e29-2d0cb4103b6e.png#averageHue=%23f8f8f8&clientId=u17ab101e-fff4-4&from=ui&height=228&id=u425f0783&originHeight=546&originWidth=1440&originalType=binary&ratio=1.6500000953674316&rotation=0&showTitle=false&size=67601&status=done&style=none&taskId=u76ab2012-752d-4ac9-a5af-453df200737&title=&width=600" width="600" /> </div>


可以看到，CPU依然按照响应优先级进行响应，但是在开中断之后，会被处理优先级更高的中断源打断。

**多重中断的断点保护**
中断系统对断点的保护是在中断周期有中断隐指令实现的，对用户透明。程序断点可以保存在以下位置：

- 堆栈：由于堆栈先进先出的特点，可以准确回到程序间断处。
- 特定存储单元：可以约定程序断点一律保持到0地址单元，为了避免之前存入的断点被覆盖，必须先将0地址的内容转存到其他地址单元中。
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682064026132-569766cb-7e8d-4084-b457-ccc92b325da6.png#averageHue=%23f3f2f2&clientId=uc97b73a1-58a5-4&from=ui&height=227&id=ud167cfdd&originHeight=635&originWidth=1118&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=29148&status=done&style=none&taskId=u92cac206-8bb6-41b1-baad-7f942c9e7a1&title=&width=400" width="400" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682064756589-0d3017bb-a183-4e03-8bb3-91b66f5d0210.png#averageHue=%23f3f3f3&clientId=uc97b73a1-58a5-4&from=ui&height=201&id=u947e6cbd&originHeight=642&originWidth=1276&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=31480&status=done&style=none&taskId=uaeea5252-e447-4018-b025-362064073f5&title=&width=400" width="400" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682064876593-6588a5c3-cef9-4510-bf78-cee396b0a09e.png#averageHue=%23f3f2f2&clientId=uc97b73a1-58a5-4&from=ui&height=138&id=uf8edca26&originHeight=465&originWidth=673&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=13576&status=done&style=none&taskId=u7e31593c-7886-42b2-87bc-1152bd0b0ca&title=&width=200" width="200" /> </div>



- 存数指令

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682064913099-780ad007-b4bc-45d4-b14e-a0f2b9034346.png#averageHue=%23f4f4f3&clientId=uc97b73a1-58a5-4&from=ui&height=133&id=u9525340e&originHeight=459&originWidth=691&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=13194&status=done&style=none&taskId=u6dea5c8e-1936-42ca-8f7d-b4f3aab736c&title=&width=200" width="200" /> </div>



- 取数指令

<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682064948562-85bbf171-c3ff-4da5-8b51-6575812656ff.png#averageHue=%23f5f5f4&clientId=uc97b73a1-58a5-4&from=ui&height=159&id=uf55bbc99&originHeight=524&originWidth=661&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=12707&status=done&style=none&taskId=u132365bb-3a15-4865-8236-8123e8ea469&title=&width=200" width="200" /> </div>
...
### 9.1.4 中断周期
中断周期要使用中断隐指令保存断点、寻找中断服务程序入口地址、硬件关中断。假设断电保存在主存0号地址，采用硬件向量法寻找入口地址。
...
### 9.2.1 控制单元外特性
以下为控制单元的外特性框图：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682065642505-7271a2d9-5b8f-41e8-826f-518d34560c67.png#averageHue=%23f9f9f9&clientId=uc97b73a1-58a5-4&from=ui&height=211&id=u7571ddd8&originHeight=647&originWidth=1534&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=64987&status=done&style=none&taskId=udde1ea18-c5ed-428b-9ecb-f004a7a4f2b&title=&width=500" width="500" /> </div>
...
- 标志：指令的执行有时依赖CPU当前所处的状态。
- 来自控制总线的控制信号：如，中端请求、DMA请求。

**输出信号**

- CPU内部控制信号：用于CPU内部寄存器之间的传送和控制ALU实现不同功能。
- 送至系统总线（控制总线）的信号：主存和I/O设备的读写命令、中断响应等。

### 9.2.2 控制信号举例
**不采用CPU内部总线的方式**
按一定时序控制门电路的开关，如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682066471674-2eae3e70-8088-4938-b85d-1a70fce920da.png#averageHue=%23f5f5f5&clientId=uc97b73a1-58a5-4&from=ui&height=319&id=u89989ee0&originHeight=623&originWidth=1369&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=110572&status=done&style=none&taskId=u4f4e3196-249d-4da5-849c-0d7eacfbb4e&title=&width=700" width="700" /> </div>



**采用CPU内部总线方式**
也是按一定时序打开对总线和部件之间的线路进行开关控制，如下：
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682066617886-6927e2fc-afe5-4491-9a70-393df0440891.png#averageHue=%23f0f0f0&clientId=uc97b73a1-58a5-4&from=ui&height=598&id=uf7ae4b2f&originHeight=1133&originWidth=568&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=122716&status=done&style=none&taskId=u7396035a-93fe-4981-9700-d029f31908c&title=&width=300" width="300" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682067344341-da6d0e22-3ad4-48fa-8199-e878ee2d6960.png#averageHue=%23f0f0f0&clientId=uc97b73a1-58a5-4&from=ui&height=233&id=ue3d09b4a&originHeight=713&originWidth=1532&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=66572&status=done&style=none&taskId=u86d32e20-6a71-41fb-8b51-56a3d9ab55f&title=&width=500" width="500" /> </div>


一般而言CPU主频越高，机器的运行速度越快，但也和机器周期中含时钟周期数和指令周期含机器周期数有关：
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682073514540-72ab9bb9-24ec-4779-8998-49437891af2c.png#averageHue=%23f6f6f6&clientId=uc97b73a1-58a5-4&from=ui&height=232&id=u0bb9ff54&originHeight=691&originWidth=1489&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=52855&status=done&style=none&taskId=u3665807c-ba05-45ec-84ba-aac2b2f9b3b&title=&width=500" width="500" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682073983187-693a922c-c7d9-4ef3-9371-4cf1c1b246b6.png#averageHue=%23f8f8f8&clientId=uc97b73a1-58a5-4&from=ui&height=248&id=u0c6c1396&originHeight=788&originWidth=1591&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=47505&status=done&style=none&taskId=u009ebf87-6256-466d-b256-7d7748edd1e&title=&width=500" width="500" /> </div>


局部节拍的每一个节拍宽度和中央控制节拍的宽度相同。局部控制的节拍要和作为中央控制节拍的延续，保证局部控制和中央控制的同步。

**异步控制**
采用应答方式。可以使得CPU没有空闲状态，结构比同步控制复杂。
...
## 10.1 组合逻辑设计
### 10.1.1 组合逻辑设计框图
指令的操作码是决定控制单元发出不同控制信号的关键。为了简化控制单元的逻辑，假设`IR`中的$n$位操作码经过译码产生$2^n$个输出信号，每一个输出信号对应一个微操作。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682421641205-ee0ae388-c29c-470b-9d33-7a9e3758076b.png#averageHue=%23f6f6f6&clientId=u8b980752-07a0-4&from=ui&height=235&id=ua0d794fb&originHeight=504&originWidth=1073&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=70335&status=done&style=none&taskId=ucc0dd4ff-df58-441e-906c-0eacbdfc0ce&title=&width=500" width="500" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682422633307-2afbb225-f3df-4cc6-9919-f771080f2c8b.png#averageHue=%23faf9f8&clientId=u8b980752-07a0-4&from=ui&height=207&id=ub3135c63&originHeight=455&originWidth=1100&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=51858&status=done&style=none&taskId=u6b26af33-c5df-450e-8df1-d0710cb237d&title=&width=500" width="500" /> </div>


一条机器指令对应一个微程序，一个微程序包含多个微指令，微指令存储在`ROM`中，一个微指令一般对应多个能够并行执行的微操作命令。

### 10.2.2 微程序控制单元框图
**机器指令对应的微程序**
微程序设计方法设计控制单元的过程：根据机器指令所需的微操作命令的先后顺序，编写每一条机器指令对应的微程序。
可以将一些机器指令共有的操作统一编成同一个微程序，如取值周期微程序、间址周期微程序、中断周期微程序。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682422780026-0a7453cf-a0c2-44a6-83db-2313abbd2ef7.png#averageHue=%23f1f1f1&clientId=u8b980752-07a0-4&from=ui&height=364&id=ud106c47e&originHeight=748&originWidth=1028&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=44537&status=done&style=none&taskId=u8929f2b8-f415-4e78-9820-7e26132f6d5&title=&width=500" width="500" /> </div>



**微程序控制单元基本框图**
微指令存储在控制存储器中，通过顺序逻辑部件产生下一条微指令的地址。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682423990660-a10d202a-6958-4e1b-93e4-3fa1a20ebffa.png#averageHue=%23f3f2f2&clientId=u8b980752-07a0-4&from=ui&height=336&id=uc2bf9953&originHeight=768&originWidth=1144&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=77168&status=done&style=none&taskId=u5bfbd849-adb0-45ba-a95b-819f863be13&title=&width=500" width="500" /> </div>


微指令的格式如下，包括操作控制部分和顺序控制部分。操作控制部分指令要进行的微操作，顺序控制指明下条微指令的地址。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682424316777-d3cdc9b9-4d6e-4d61-bed4-0c1282db1952.png#averageHue=%23ededed&clientId=u8b980752-07a0-4&from=ui&height=88&id=ude03a81a&originHeight=130&originWidth=591&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=18321&status=done&style=none&taskId=u3925119f-f791-42b8-89c6-7f0375475ce&title=&width=400" width="400" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682424763048-59719512-6b8a-4309-aa17-220911d2f0e0.png#averageHue=%23eeeeee&clientId=u8b980752-07a0-4&from=ui&height=113&id=uae379572&originHeight=220&originWidth=970&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=10544&status=done&style=none&taskId=ua0b578b9-6600-4807-beaa-43cfa6a217b&title=&width=500" width="500" /> </div>



**字段直接编码方式**
将不能同时执行的（互斥）微操作放在同一个字段中（一个字段的译码输出只有一个位有效，对应一个微操作），一个$n$位字段通过译码电路译码产生$2^n$种输出，对应不同的微操作。这种方式缩短了微指令长度，但是增加了译码电路，使得微程序执行速度稍微减慢。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682424809417-75121cc5-8e9f-41ab-81ff-6e8434931f2e.png#averageHue=%23f3f3f3&clientId=u8b980752-07a0-4&from=ui&height=155&id=u1cd97f23&originHeight=327&originWidth=1055&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=14989&status=done&style=none&taskId=u67aa2cd5-abd1-4cc3-a097-3beae14c618&title=&width=500" width="500" /> </div>



**字段间接编码方式**
一个字段的某些为命令还需要另一个字段中某些微命令来解释。进一步缩短微指令字长，但是削弱了微指令的并行控制能力，通常作为字段直接编码的一种富足手段。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682425043107-6939d3d7-d46a-431e-a90a-d14e8c2ce5e3.png#averageHue=%23f4f4f4&clientId=u8b980752-07a0-4&from=ui&height=209&id=ua7063b2c&originHeight=423&originWidth=1014&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=20090&status=done&style=none&taskId=u4d007264-4155-4b2e-a101-1fdf641e10c&title=&width=500" width="500" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682425503427-242b7606-33c1-4a03-9dd6-5216542ad4e5.png#averageHue=%23ececeb&clientId=u8b980752-07a0-4&from=ui&height=59&id=uf332e0ef&originHeight=127&originWidth=1083&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=10452&status=done&style=none&taskId=uccc7b1dd-37c1-4cbf-a84b-9802c54fc06&title=&width=500" width="500" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682425644313-308139f1-bad8-4365-9c9b-06cd2015cee1.png#averageHue=%23f0efef&clientId=u8b980752-07a0-4&from=ui&height=183&id=u1f474d2b&originHeight=406&originWidth=1098&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=26766&status=done&style=none&taskId=u79ac5cd3-80b1-48ee-901b-425d157e824&title=&width=495" width="495" /> </div>
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682432566501-f8347006-025d-48f8-9278-8edfacbb3729.png#averageHue=%23f5f5f5&clientId=ue6f4fc45-4a4a-4&from=ui&height=414&id=u92b009d6&originHeight=722&originWidth=1220&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=49683&status=done&style=none&taskId=u4d3ea95c-d683-4b50-abdd-6f3ec3b7709&title=&width=700" width="700" /> </div>



### 10.2.5 微指令格式
**水平型微指令**
一次能够定义并执行多个并行操作的微命令。如之前谈到的指令编码格式的所有指令。
...
### 10.2.7 毫微程序设计
机器指令用微程序解释，微程序又可以用毫微程序解释，也就是微指令可以用毫微指令解释。采用毫微程序设计的计算机优点是使用少量的控制存储器空间来达到高度并行。
...
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682432672990-a63a08e3-0522-4fad-9cd5-2480a739dad4.png#averageHue=%23f3f3f2&clientId=ue6f4fc45-4a4a-4&from=ui&height=322&id=u6c30dff0&originHeight=536&originWidth=1165&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=40832&status=done&style=none&taskId=u6c8cf17b-5426-417d-bca0-6751625d7c7&title=&width=700" width="700" /> </div>



### 10.2.8 串行和并行微程序控制
完成一条微指令也分为两个阶段：取微阶段和执行阶段。两个阶段的的操作是在不同的部件中完成的，可以并行执行，形成二级流水。
<div align="center"> <img src="https://cdn.nlark.com/yuque/0/2023/png/29674612/1682432350195-b3e3986d-a8a3-491d-b5e2-e5428a92e9c2.png#averageHue=%23f2f2f2&clientId=ue6f4fc45-4a4a-4&from=ui&height=203&id=u1c91bb90&originHeight=491&originWidth=1696&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=138215&status=done&style=none&taskId=ude18d2f3-9a33-476c-8dc5-07de94e1657&title=&width=701" width="701" /> </div>
